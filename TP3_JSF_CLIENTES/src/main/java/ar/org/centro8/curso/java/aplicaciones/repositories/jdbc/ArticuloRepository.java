...
public class ArticuloRepository implements I_ArticuloRepository{
    ...
    public void save(Articulo articulo) {
        ...
        try(PreparedStatement ps = conn.prepareStatement("insert into articulos(descripcion, tipo, color, talle_num, stock, stockMin, stockMax, costo, precio, temporada) values (?,?,?,?,?,?,?,?,?,?)",
            PreparedStatement.RETURN_GENERATED_KEYS))
        {
            //return "Articulo{" + "id=" + id + ", descripcion=" + descripcion + ", 
            //tipo=" + tipo + ", color=" + color + ", talle_num=" + talle_num + ", 
            //stock=" + stock + ", stockMin=" + stockMin + ", stockMax=" + stockMax + 
            //", costo=" + costo + ", precio=" + precio + ", temporada=" + temporada + '}';
           ...
           ps.execute();
            ...
            //le inserto el id generado en la bd al objeto Alumno recibido por parametro
    ...
    public void update(Articulo articulo) {
        ...
        + "stock = ?, stockMin = ?, stockMax = ?, costo = ?, precio = ?, "
        + "temporada = ? where id = ?")){
           ps.setString(1, articulo.getDescripcion());
           ps.setString(2, articulo.getTipo().toString());
           ps.setString(3, articulo.getColor());
